...
shinyUI(pageWithSidebar(
    ...
    mainPanel(
        ...
        p("As you can check using this app, the clusters are associated with the User Name variable but they are not related with the variable classe."),
        ...
        p("The predictor variables were preprocessed by the methods of CARET package “YeoJohnson”,“center”, “scale”,“pca”. The purpose of preprocessing was respectively: “symmetry”, “centering”, “scaling” and “dimensional reduction”."),
